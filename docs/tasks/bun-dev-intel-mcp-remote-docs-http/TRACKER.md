...
- Notes: All tasks 00-24 are done. Local stdio remains owned by `bun-dev-intel-stdio-mcp`; a later reintegration brought the admin console back into this repository as an optional app.

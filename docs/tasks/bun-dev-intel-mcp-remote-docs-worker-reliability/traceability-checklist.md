...
| Running timeout configuration | `src/config/remote-docs-config.ts`, `.env.remote-docs.example`, `docs/deployment/remote-docs-http.md` | `tests/unit/config/remote-docs-config.test.ts`, `tests/unit/deployment/docker-config.test.ts` | done |
...
| Deployment monitoring and recovery docs | `.env.remote-docs.example`, `docs/deployment/remote-docs-http.md` | `tests/unit/deployment/docker-config.test.ts`, `tests/unit/deployment/remote-docs-handoff.test.ts` | done |

import { parseRemoteDocsConfig, type RemoteDocsConfigIssue } from "../../../src/config/remote-docs-config";
import { createRemoteHttpApp } from "../../../src/http/app";
import { createRemoteDocsMcpHandler } from "../../../src/http/mcp";
import { createRemoteDocsServerDependencies, type ServerDependencies } from "../../../src/server";
